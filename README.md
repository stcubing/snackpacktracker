...
While my knowledge on this technology is still extremely amateurish, I learnt a lot about app development and working with a language and environment I had wanted to learn for a while, so I'm pretty satisfied in the end. Even better is that I get to log all my HSPs in a nice little app!! How lovely.
